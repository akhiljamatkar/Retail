CREATE EXTERNAL TABLE IF NOT EXISTS `akhil-project-8380.bronze_dataset.orders`(
    order_id INT64,
    customer_id INT64,
    order_date STRING,
...
CREATE EXTERNAL TABLE IF NOT EXISTS `akhil-project-8380.bronze_dataset.customers`
(
    customer_id INT64,
    name STRING,
    email STRING,
...
CREATE EXTERNAL TABLE IF NOT EXISTS `akhil-project-8380.bronze_dataset.products`
(
    product_id INT64,
    name STRING,
    category_id INT64,
...
CREATE EXTERNAL TABLE IF NOT EXISTS `akhil-project-8380.bronze_dataset.categories`
(
    category_id INT64,
    name STRING,
    updated_at STRING
...
CREATE EXTERNAL TABLE IF NOT EXISTS `akhil-project-8380.bronze_dataset.order_items`
(
    order_item_id INT64,
    order_id INT64,
    product_id INT64,
...
-------------------------------------------------------------------------------------------------------------
-- Suppliers Table
CREATE EXTERNAL TABLE IF NOT EXISTS `akhil-project-8380.bronze_dataset.suppliers` (
    supplier_id INT64,
...
CREATE EXTERNAL TABLE IF NOT EXISTS `akhil-project-8380.bronze_dataset.product_suppliers` (
    supplier_id INT64,
    product_id INT64,
...
CREATE OR REPLACE EXTERNAL TABLE `akhil-project-8380.bronze_dataset.customer_reviews` (
  id STRING,
  customer_id INT64,
  product_id INT64,
  rating INT64,
