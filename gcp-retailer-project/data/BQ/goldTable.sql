...
CREATE TABLE IF NOT EXISTS `akhil-project-8380.gold_dataset.sales_summary`
AS
SELECT 
    o.order_date,
    p.category_id,
...
CREATE TABLE IF NOT EXISTS `akhil-project-8380.gold_dataset.customer_engagement`
AS
SELECT 
    c.customer_id,
...
CREATE TABLE IF NOT EXISTS `akhil-project-8380.gold_dataset.product_performance`
AS
SELECT 
    p.product_id,
    p.name AS product_name,
...
CREATE TABLE IF NOT EXISTS `akhil-project-8380.gold_dataset.supplier_analysis`
AS
SELECT 
    s.supplier_id,
    s.supplier_name,
...
CREATE TABLE IF NOT EXISTS `akhil-project-8380.gold_dataset.customer_reviews_summary`
AS
SELECT 
    p.product_id,
    p.name AS product_name,
